#!/usr/bin/env python3
"""
   A Script That Trains The Neural Network
"""
...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        """
        Trains the neural network by performing forward propagation and gradient descent.
        ...
        Updates:
            __W1, __b1, __A1, __W2, __b2, __A2: Network parameters during training.

        Returns:
            tuple: Evaluation of the training data (prediction, cost).
        """
