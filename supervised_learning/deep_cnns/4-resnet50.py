#!/usr/bin/env python3
"""Module that defines the resnet50 function."""
...
def resnet50():
    ...
    It uses an initial convolution and pooling layer followed
    by projection and identity blocks, ending with average
    pooling and a softmax output layer.

    Returns:
        The Keras model for the ResNet-50 network.
    """
